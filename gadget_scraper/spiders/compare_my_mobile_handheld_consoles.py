...
class CompareMyMobileHandheldConsolesSpider(Spider):
    name = "compare_my_mobile_handheld_consoles"
    ...
    def start_requests(self):
        ...
        requests.append(Request(
            url="http://www.comparemymobile.com/sell/nintendo-trade-in",
            meta={"make": "Nintendo"},
    ...
    def parse_sony_page(self, response):
        ...
        for device_div in response.xpath(self.sony_device_div_xpath):
            ...
            if "PSP" in model or "Vita" in model:
                ...
                for option_div in option_divs:
                    ...
                    ## For example, "Wifi + 3G prices" becomes just "Wifi + 3G"
